...
var (
	...
	CollectorPrometheusExporterProxyURLKey      = pre(CollectorPrometheusExporterKey) + "proxy_url"
	CollectorPrometheusExporterProxyNoProxyKey  = pre(CollectorPrometheusExporterKey) + "proxy_no_proxy"
